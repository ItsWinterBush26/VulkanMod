...
// The VK12 import for the version constant is no longer needed:
// import static org.lwjgl.vulkan.VK12.VK_API_VERSION_1_2;
import static org.lwjgl.vulkan.VK11.VK_API_VERSION_1_1; // Explicitly using 1.1
...
//            Thread.dumpStack();
    ...
    private static void createInstance() {
        ...
        try (MemoryStack stack = stackPush()) {
            ...
            // --- CHANGE HERE: Targeting Vulkan 1.1 instead of 1.2 ---
...
//        debugCreateInfo.messageType(VK_DEBUG_UTILS_MESSAGE_TYPE_GENERAL_BIT_EXT | VK_DEBUG_UTILS_MESSAGE_TYPE_VALIDATION_BIT_EXT);
    ...
    private static void createVma() {
        try (MemoryStack stack = stackPush()) {
            ...
            // --- CHANGE HERE: Inform VMA we are targeting Vulkan 1.1 ---
